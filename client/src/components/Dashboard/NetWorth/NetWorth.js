    ...
    return (
        ...
        {fetching
          ...
          : <div className='net-worth dashboard-item'>
                ...
                <p>
                    30-day:<span style={{color: differenceColor(lastMonthDifference)}}>{formattedNumber(lastMonthDifference)}€</span>
                    90-day:<span style={{color: differenceColor(lastThreeMonthsDifference)}}>{formattedNumber(lastThreeMonthsDifference)}€</span>
                </p>
            </div>
        }
        </>
