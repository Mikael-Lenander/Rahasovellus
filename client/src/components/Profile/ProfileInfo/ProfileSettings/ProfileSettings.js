	...
	return (
		<div className='profile-settings'>
				...
				<div className='form-container'>
						...
						<div className='row form-group'>
							<div className='col-9'>
								<input
									...
									step='0.01'
									value={initCapital}
									onChange={event => setInitCapital(event.target.value)}
								/>
							</div>
					...
					<form className='profile-form' onSubmit={onUpdatePassword}>
						...
						<div className='row form-group password-field'>
							...
							<div className='col-3' style={{ padding: 0 }}>
								<button type='submit' className='btn btn-danger' disabled={user.username === 'demouser'}>
									Save
								</button>
							</div>
						</div>
			...
			{updateMessage.message && (
				<div className={`alert alert-message alert-${updateMessage.success ? 'success' : 'danger'}`} role='alert'>
					{updateMessage.message}
				</div>
			)}
		</div>
