import {ADD_TRANSACTION, DELETE_TRANSACTION, FETCH_TRANSACTIONS, LOADING_TRANSACTIONS, UPDATE_TRANSACTION_CATEGORIES} from '../constants/actionTypes'
...
const transactionsReducer = function(state=defaultState, action) {
    switch(action.type) {
        ...
        case UPDATE_TRANSACTION_CATEGORIES:
            return {data: state.data.map(transaction => {
